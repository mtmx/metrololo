---
title: "[Metrololo #3] Gentrification résidentielle"
author: "Mathieu"
date: 2017-06-25
output: html_document
categories: ["R"]
tags: ["metros", "ville", "diplômés","gentrification"]
...
Après deux épisodes consacrés aux [enfants](https://mtmx.github.io/post/metrololo_poussettes/) et aux [mamies](https://mtmx.github.io/post/metrololo_mamies/), on rentre dans le tas en abordant un sujet sensible : la gentrification. Parce qu'il semble que tout le monde peut prétendre avoir un avis sur le sujet, je m'y mets aussi. 
...
REF_stations.Z.contig.wgs84 <- readShapeSpatial("./extract/REF_stations.Z.contig.wgs84.shp" ,proj4string=CRS("+init=epsg:4326"))
...
library(png)
library(grid)
img <- readPNG("./extract/ecran_discontinuites_NE.png")
 grid.raster(img)
