---
title: "[Metrololo #2]  Des poussettes dans la ville"
author: "Mathieu"
date: "07/06/2017"
output: html_document
categories: ["R"]
tags: ["metros", "ville", "enfants"]
...
Après un [premier épisode](https://mtmx.github.io/post/metrololo_mamies/) consacré aux `r emo::ji("older_woman")`, venons-en aux `r emo::ji("baby")`
...
```{r france 1990,echo=F, message=F, warning=F, fig.width=4.66,fig.height=4,out.extra='style="float:left"'}
...
CV_RP1990_2013 <- read.csv2( "./extract/CV_RP1990_2013.csv")
CV_spdf.s <- readShapeSpatial("./extract/CV_spdf.s.shp" ,proj4string=CRS("+init=epsg:2154"))
dep.s <- readShapeSpatial("./extract/dep.s.shp" ,proj4string=CRS("+init=epsg:2154"))
...
```{r france 2013,echo=F, message=F, warning=F, fig.width=4.66,fig.height=4, out.extra='style="float:left"'}
...
```{r france 1990_2013,echo=F, message=F, warning=F, out.width='.49\\linewidth', fig.width=3, fig.height=3,fig.show='hold',fig.align='center'}
